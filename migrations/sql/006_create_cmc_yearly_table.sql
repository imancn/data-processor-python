-- Migration: 006_create_cmc_yearly_table.sql
-- Description: Create table for CMC yearly cryptocurrency data

CREATE TABLE IF NOT EXISTS cmc_yearly (
    id UInt64,
    name String,
    symbol String,
    slug String,
    ...
    time_interval_start DateTime('UTC') MATERIALIZED toStartOfYear(timestamp),
...
TTL timestamp + INTERVAL 100 YEAR;
