-- Migration: 005_create_cmc_monthly_table.sql
-- Description: Create table for CMC monthly cryptocurrency data

CREATE TABLE IF NOT EXISTS cmc_monthly (
    id UInt64,
    name String,
    symbol String,
    slug String,
    ...
    time_interval_start DateTime('UTC') MATERIALIZED toStartOfMonth(timestamp),
