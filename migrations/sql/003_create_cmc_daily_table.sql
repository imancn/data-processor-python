-- Migration: 003_create_cmc_daily_table.sql
-- Description: Create table for CMC daily cryptocurrency data

CREATE TABLE IF NOT EXISTS cmc_daily (
    id UInt64,
    name String,
    symbol String,
    slug String,
    ...
    self_reported_circulating_supply Nullable(Decimal64(2)),
    self_reported_market_cap Nullable(Decimal64(2)),
    tvl_ratio Nullable(Decimal64(4)),
    time_scope String,
    ...
    time_interval_start DateTime('UTC') MATERIALIZED toStartOfDay(timestamp),
